...
describe('LoginPage', () => {
  ...
  it('given user is recovering password, when success, then hide loading and show sucess', () => {
  ...
  it('given user is recovering password, when error, then hide loading and show error', () => {
    spyOn(toastController, 'create').and.returnValue(<any> Promise.resolve({present: () => {}}));
  ...
  it('given user is logging in, when sucess, then hide loading and send user to home page', () => {
    spyOn(router, 'navigate');
    fixture.detectChanges();
  ...
  it('given user is logging in, when error, then hide loading and send user to error page', () => {
    spyOn(toastController, 'create').and.returnValue(<any> Promise.resolve({present: () => {}}));
    fixture.detectChanges();
    store.dispatch(login({email: "valid@email.com", password: "anyPassword"}));
